...
const Sidebar = () => {
  ...
  return (
    <section className="sticky top-0 left-0 bg-gray-200 pt-[6rem] flex h-screen flex-col justify-between overflow-auto border-r border-r-dark-4 max-md:hidden w-[200px] max-lg:w-[100px] px-5">
